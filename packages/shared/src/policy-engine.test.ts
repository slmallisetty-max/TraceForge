...
import {
  PolicyEngine,
  type EnforceablePolicyContract,
...
describe("PolicyEngine", () => {
  ...
  describe("Organizational Hierarchy", () => {
    ...
    it("should return organization policies for matching org", () => {
      ...
      const notApplicable = engine.getApplicablePolicies(
        "org-other",
        "service-1"
      );
    ...
    it("should return service policies for matching org and service", () => {
      ...
      const wrongService = engine.getApplicablePolicies(
        "org-acme",
        "service-other"
      );
    ...
    it("should filter by enforce_at_proxy flag", () => {
      ...
      const enforcedOnly = engine.getApplicablePolicies(
        undefined,
        undefined,
        true
      );
