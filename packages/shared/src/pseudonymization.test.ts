...
describe('Pseudonymizer', () => {
  ...
  describe('Credit Card Pseudonymization', () => {
    it('should pseudonymize credit card numbers', () => {
      const result = pseudonymizer.pseudonymizeCreditCard('4532-1234-5678-9010');
    ...
    it('should return consistent pseudonyms', () => {
      const result1 = pseudonymizer.pseudonymizeCreditCard('4532-1234-5678-9010');
      const result2 = pseudonymizer.pseudonymizeCreditCard('4532-1234-5678-9010');
  ...
  describe('Reversibility', () => {
    it('should support reversible pseudonymization when configured', () => {
      ...
      const result = reversiblePseudonymizer.pseudonymizeEmail('john@example.com');
  ...
  describe('Mapping Management', () => {
    ...
    it('should reset counter after clearing', () => {
      ...
      const firstId = pseudonymizer.pseudonymizeEmail('first@example.com').pseudonym;

      pseudonymizer.clearMappings();

      pseudonymizer.pseudonymizeEmail('second@example.com');
      const secondId = pseudonymizer.pseudonymizeEmail('second@example.com').pseudonym;
