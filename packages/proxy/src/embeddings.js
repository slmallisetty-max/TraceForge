...
export class OpenAIEmbeddingService {
    ...
    baseUrl;
    model;
    constructor(apiKey, baseUrl = 'https://api.openai.com/v1', model = 'text-embedding-3-small') {
        this.apiKey = apiKey;
...
export class CachedEmbeddingService {
    ...
    cacheDir;
    cache = new Map();
    constructor(upstream, cacheDir = '.ai-tests/embeddings') {
 ...
 */
export function getDefaultEmbeddingService(useCache = true) {
